...
class StudentRegistration(http.Controller):
        ...
        if request.session.get('is_data') and kw.get('check_data'):
            if kw.get('fname') and kw.get('lname'):
                ...
                if old_partner:
                    ...
                    return request.render('bi_massage_center_management.registration_create_massage', {'massage': massage, 'admission': admission})
    ...
    def inquiry_create(self, **kw):
        ...
        if request.session.get('is_data'):
            ...
            if inquiry:
                ...
                return request.render('bi_massage_center_management.registration_create_massage', {'massage': massage, 'admission': inquiry})
            else:
                return request.render('bi_massage_center_management.registration_create_massage', {'massage': massage, 'admission': inquiry})
        else:
            return request.render('bi_massage_center_management.registration_create_massage', {'massage': massage, 'admission': inquiry})
    ...
    def registration(self, **kw):
        ...
        studies = request.env['product.product'].sudo().search(
            [('is_sportname', '=', True)])
        return request.render('bi_massage_center_management.registration', {'states': states, 'studies': studies, 'centers' :centers})
    ...
    def inquiry(self, **kw):
        ...
        studies = request.env['product.product'].sudo().search(
            [('is_sportname', '=', True)])
        return request.render('bi_massage_center_management.inquiry', {'centers': centers, 'studies': studies})
    ...
    def book_ground_confirm(self, **kw):
        ...
        if booking:
            ...
            return request.render('bi_massage_center_management.registration_create_massage', {'massage': massage})
    ...
    def book_ground(self, **kw):
        ...
        [('is_sportname', '=', True)])
        return request.render('bi_massage_center_management.booking', {'grounds': grounds, 'sports':sports})
...
class EventPortal(CustomerPortal):
    ...
    def portal_my_events(self, page=1, date_begin=None, date_end=None, search=None, search_in='all', sortby=None, filterby=None, groupby='none', **kw):
        ...
        return request.render("bi_massage_center_management.portal_my_events", values)
    ...
    def event_followup(self, event_id=None, report_type=None, download=False, access_token=None, **kw):
        ...
        return request.render("bi_massage_center_management.event_followup", values)
