...
class ReservationConflictWizard(models.TransientModel):
    ...
    def confirm_reservation(self):
        ...
        active_admission = self.env['student.admission'].browse(self.env.context.get('active_id'))
        active_admission.sudo().action_create_reservation_auto_multi()
        active_admission.state = 'enrolled'
