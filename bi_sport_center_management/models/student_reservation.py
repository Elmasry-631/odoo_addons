...
class StudentReservation(models.Model):
    ...
    student_mobile = fields.Char(related='admission_id.mobile')
    student_email = fields.Char(related='admission_id.email')
    is_student_attend = fields.Boolean('Trainee Attendance')
    ...
    def action_change_details(self):
        ...
        return {
            ...
            'view_type': 'form',
            'view_mode': 'form',
            'res_model': 'reservation.change.wizard',
            'view_id': view_id,
            'context': context,
            'target': 'new',
        }
